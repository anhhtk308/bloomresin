                    ...
                    <table class="table table-bordered table-hover text-center align-middle">
                        ...
                        <c:forEach var="customOrder" items="${customOrders}" varStatus="loop">
                            <tr>
                                ...
                                <td>
                                    <a href="/employee/custom-order/detail/${customOrder.id}" class="btn btn-sm btn-success">
                                        <i class="bi bi-eye"></i> Xem
                                    </a>
                                    <a href="/employee/custom-order/delete/${customOrder.id}" class="btn btn-sm btn-danger"
